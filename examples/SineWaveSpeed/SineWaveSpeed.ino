...
void setup() {
  ...
  // Initialize the motor hardware abstraction layer.
    // Using default motor_id = 0 (Implicit)
        ...
        hal_motor_init(MOTOR_PWM_A_PIN, MOTOR_PWM_B_PIN, MOTOR_BEMF_A_PIN, MOTOR_BEMF_B_PIN, NULL, 0, 10);
    #else
        ...
        hal_motor_init(LED_PWM_A_PIN, LED_PWM_B_PIN, MOTOR_PIN_UNDEFINED, MOTOR_PIN_UNDEFINED, NULL, 1, 10);
    #endif
